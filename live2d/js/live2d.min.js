...
function(t) {
	...
	function o(t) {
    //console.log(t); //live2d
    //console.log(g);         
		C = document.getElementById(t), C.addEventListener && (
	...
	function u(t) {
		...
		var i = C.getBoundingClientRect(),
			...
			n = m(o.x - i.left),
			s = T(o.y - i.top);
      if(isNaN(t.clientX)) t.clientX = 1; //By Feather Mountain
      if(isNaN(n)) n = 4.79;              //By Feather Mountain      
		w.
...
default = o;
    ...
    //o = "../model/Potion-Maker/Tia/motions/Breath3.mtn";
    //var o = this.modelSetting.getMotionFile(t, 3);
